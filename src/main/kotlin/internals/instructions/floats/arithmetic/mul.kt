...
/**
 * Multiplies the values in two registers and stores the result in the `R1` register.
 *
 ...
 */
fun Floats.fMul(registerA: FloatingRegisterType, registerB: FloatingRegisterType): Unit = try {
    ...
    errors.run<VMErrors, Unit> { this@run.GeneralArithmeticException(message = "fMul") }
}